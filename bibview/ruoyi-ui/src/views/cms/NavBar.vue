<template>
  <el-header :style="'margin-bottom:'+ headerBottom +'px'">
    <h2 class="logo"><svg-icon icon-class="EarOfWheat" />  Bibview</h2>
    ...
    <div v-if="searchInput" class="search_input">
      <el-input @focus="checkInput" @blur="notSearching()" class="search" placeholder="搜索文献"
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          <router-link target="_blank" to="/index">
            <el-dropdown-item>管理文献</el-dropdown-item>
          </router-link>
